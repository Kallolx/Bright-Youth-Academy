...
const GridBlock = () => {
  return (
    <div className="flex flex-col items-start justify-center w-48 sm:w-56">
...
const Dot = () => {
  return (
    <div className="h-4 w-4 flex items-center justify-center rounded-full">
...
const SVGVertical = ({ className }: { className?: string }) => {
  ...
  return (
    <motion.svg
      ...
      className={cn("text-purple-500/15 dark:text-purple-400/15", className)}
    >
      ...
      <defs>
        ...
        >
          ...
          <motion.stop offset="50%" stopColor="rgba(168, 85, 247, 0.3)" />
