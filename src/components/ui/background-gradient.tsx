...
export const BackgroundGradient: React.FC<BackgroundGradientProps> = ({
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className="absolute -inset-px bg-gradient-to-r from-[#A656F7] to-[#3C81F6] bg-opacity-90 rounded-xl opacity-0 group-hover/card:opacity-100 blur transition duration-1000 group-hover:duration-200" />
